...
class AlertEnricherTest {
    ...
    @Test
    fun `enrich aggregates provider-agnostic contexts across all registered providers`() =
        runBlocking {
    ...
    @Test
    fun `enrich handles individual provider failure gracefully without failing entire pipeline`() =
        runBlocking {
            val failingProvider =
                FakeContextProvider(
